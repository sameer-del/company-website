      ...
      >
        <div className="max-w-5xl mx-auto text-center px-4">
          ...
          <p className="text-[19px] mb-6 font-[secondary]">
            Seamlessly integrate with third-party services, applications, and
            systems using our powerful External API Connector.
          </p>
        </div>
      </header>
        ...
        <div className="grid lg:grid-cols-2 place-items-center">
          <div className=" flex flex-col justify-center items-center gap-2  ">
            <h1 className=" lg:text-[30px] font-bold text-[25px] mb-2 uppercase font-serif text-center ">
              Simplify Integration with Our External API Connector
            </h1>
            <p className="text-[18px] font-[secondary] lg:max-w-[85%] text-center px-2">
              Seamlessly integrate with third-party services, applications, and
              systems using our powerful External API Connector. Designed for
              ease of use and flexibility, this connector empowers businesses to
              securely exchange data, automate processes, and enhance
              interoperability with minimal setup.
            </p>
            <Link href="#more">
