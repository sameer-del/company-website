    ...
    <div className="bg-gray-50">
      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-4 py-2  mt-5">
          ...
          <div className="bg-white rounded-[15px] flex  py-4 px-4 flex-col justify-center p-10">
            <h3 className="text-xl font-semibold text-gray-800 mb-3">
      ...
      <section className=" max-w-[98%] mx-auto bg-black py-10 rounded-[15px] mt-[20px] px-10">
        <div className="max-w-[95%] mx-auto px-6">
          <h2 className="text-[29px] font-[secondary] uppercase font-bold text-white mb-6 text-center ">
            Key Features
          </h2>
          <div className="grid md:grid-cols-3 gap-8">
      ...
      {/* Call to Action */}
      <section
        className="text-center bg-blue-600 text-white py-16"
        id="contact"
      >
