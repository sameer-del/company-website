  ...
  const Data = [
    {
      title: "Customers",
      description:
        "Simplified issue reporting and tracking enhance trust and satisfaction.",
    },
    {
      title: "Development Teams",
      description:
        "Streamlined workflows and screen recordings improve productivity and resolution times.",
    },
    {
      title: "Management",
      description:
        "Comprehensive visibility into production issues and resolution timelines.",
    },
  ];
