...
const productsData: Record<ProductKeys, Product> = {
  "workflow-engine": {
    title: "Workflow Engine",
    description:
      "Streamline your business processes with our intuitive Workflow Engine.",
  },
  "rule-engine": {
    title: "Rule Engine",
    description:
      "Automate decision-making and enforce business policies with precision.",
  },
  "loan-calculator-engine": {
    title: "Loan Calculator Engine",
    description:
      "Calculate precise loan details and amortization schedules effortlessly.",
  },
  "report-designer": {
    title: "Report Designer",
    description:
      "Create stunning, customized reports to visualize your data effectively.",
  },
  "letter designer": {
    title: "Report Designer",
    description:
...
export default function ProductPage({
  ...
  if (!(product in productsData)) {
    return notFound(); // Handles the case when the product is not found
  }

  const productContent = productsData[product as ProductKeys];

  return (
    <div className="text-center">
      {/* <h1 className="text-4xl font-bold mb-4">{productContent.title}</h1>
      <p className="text-lg text-gray-600">{productContent.description}</p> */}
          ...
          <div className="grid grid-cols-2 ">
            <div className=" flex flex-col justify-center gap-2  ">
              ...
              <p className="text-[19px] font-[secondary] max-w-[85%]">
                ...
                solution delivers precise amortization schedules while
                seamlessly integrating with your systems for an unparalleled
                experience.
              </p>
        ...
        <section className=" max-w-[98%] mx-auto bg-black py-10 rounded-[15px] mt-[20px] px-10">
          ...
          <div className="w-full bg-white text-center text-[19px] font-[secondary] rounded-[15px] py-10 mt-5">
            <p className="max-w-[85%] mx-auto">
              ...
              personal loan, our engine simplifies the process by providing
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow h-[50vh] flex flex-col justify-center gap-5">
                ...
                <p className="text-gray-700 text-[19px] font-[secondary]">
                  ...
                  Engine analyzes historical data and user preferences to
                  suggest the most optimal amortization methods. Its intelligent
                  design ensures accuracy and relevance, continuously improving
                  with each use.
                </p>
                <button className="mt-5 w-[150px] bg-black py-4 rounded-full text-white font-serif ">
                  view more
              ...
              <div className="bg-white p-6 rounded-lg shadow flex flex-col justify-center">
                ...
                <p className="text-gray-700 text-[19px] font-[secondary]">
                  ...
                  adjusts resources based on application load. Whether during
                  peak traffic or high computation demands, it delivers seamless
              ...
              <div className="bg-white p-6 rounded-lg shadow flex flex-col justify-center">
                ...
                <p className="text-gray-700 text-[19px] font-[secondary]">
                  ...
                  flexible subscription plans, it’s designed to adapt to the
                  needs of businesses of all sizes, ensuring you stay ahead in
        ...
        <section className="text-center bg-blue-600 text-white py-16">
          <div className="max-w-3xl mx-auto px-4">
            ...
            <p className="text-lg mb-6">
              Our Loan Calculator Engine is trusted by industry leaders. Join
              them and simplify your financial processes today!
            </p>
